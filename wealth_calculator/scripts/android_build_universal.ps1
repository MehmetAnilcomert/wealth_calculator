Write-Host "=== Universal Flutter Android Build Script ===" -ForegroundColor Cyan
Write-Host ""

# Proje dizinini al (parametre veya current directory)
param(
...
Write-Host ">>> Proje: $ProjectPath" -ForegroundColor Green
Write-Host ""
